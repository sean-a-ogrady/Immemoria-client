...
function NotFound() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-72px)] bg-light-background dark:bg-dark-background"> {/* Adjust the min-h value based on the height of your navigation bar */}
            ...
            <p className="mb-4 text-lg text-center sm:text-center text-light-secondary-text dark:text-dark-secondary-text">
                Fear not, for not all who wander are lost.
            </p>
            <button onClick={goHome} className="px-5 py-3 rounded-md text-lg text-center sm:text-center text-light-primary-text dark:text-dark-primary-text bg-light-accent dark:bg-dark-accent hover:bg-light-sidebar dark:hover:bg-dark-sidebar focus:outline-none focus:ring-2 focus:ring-inset focus:ring-dark-accent">
                Return to the known
            </button>
        </div>
    );
